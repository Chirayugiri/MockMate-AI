...
const Agent = ({
  ...
  const [loadingEnd, setLoadingEnd] = useState(false); // ✅ new
  ...
  useEffect(() => {
    ...
    const onError = (error: any) => {
      console.error("❌ Vapi error caught:");
  ...
  const handleDisconnect = async () => {
    setLoadingEnd(true); // ✅ show loader
    ...
    try {
      if (!interviewId) {
        throw new Error("interviewId is required to create feedback.");
      }
